...
def get_drug_disease_mapping(name_to_icd_and_confidences, name_to_drug, synonym_to_drug, icd_to_mesh_ids,
...
def get_drug_disease_mapping_from_cui(name_to_cui_and_confidences, name_to_drug, synonym_to_drug, concept_id_to_mesh_id,
                                      mesh_id_to_name, dump_file):
    """
